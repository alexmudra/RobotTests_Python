...
#${DBHost}  192.168.1.12   #це дефолтне значення і можна записати інше, можна прописати адресу іншого хоста бд
#${DBHost}  27.32.123.32   #це дефолтне значення і можна записати інше, можна прописати адресу іншого хоста бд
#${DBHost}  94.158.92.135   #це дефолтне значення і можна записати інше, можна прописати адресу іншого хоста бд
#${DBHost}  0.0.0.0.   #це дефолтне значення і можна записати інше, можна прописати адресу іншого хоста бд
#${DBHost}   192.168.12.12   #це дефолтне значення і можна записати інше, можна прописати адресу іншого хоста бд

${DBPort}       3306        #це дефолтне значення і можна записати інше
#${DBPort}  12345        #це дефолтне значення і можна записати інше
